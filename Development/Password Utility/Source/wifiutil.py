...
# Get WiFi device interface 
def getPlatformPortName():
  airportDevice = commands.getoutput('networksetup -listallhardwareports | grep -E "Wi-Fi|AirPort" -A 1 | grep -o en.')
